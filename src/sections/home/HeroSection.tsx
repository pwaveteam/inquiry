...
>
<h2 className="text-[50px] leading-[1.3] tracking-[-0.03em] mb-[30px] drop-shadow-[0_3px_10px_rgba(0,0,0,0.8)] font-normal">
1명 인건비로 CTO부터 QA까지<br />
<span className="font-semibold">기획부터 개발까지, 모든 과정을 한 번에</span>
</h2>

<p className="text-[26px] leading-[1.3] tracking-[-0.03em] text-white/95 mb-[40px] drop-shadow-[0_2px_6px_rgba(0,0,0,0.7)]">
