      ...
      html:`
        <div style="font-family:'Pretendard',sans-serif;padding:24px;background:#fafafa">
          ...
          <table style="width:100%;border-collapse:collapse">
            <tr><td style="padding:8px 0"><b>이름</b></td><td>${name}</td></tr>
            <tr><td style="padding:8px 0"><b>회사명</b></td><td>${company||'-'}</td></tr>
            <tr><td style="padding:8px 0"><b>연락처</b></td><td>${phone}</td></tr>
            <tr><td style="padding:8px 0"><b>이메일</b></td><td>${email}</td></tr>
          </table>
          <div style="margin-top:20px">
            <b>문의내용</b>
            <div style="margin-top:8px;padding:12px;border:1px solid #e5e5e5;border-radius:6px;background:#fff;line-height:1.6;white-space:pre-wrap">${message}</div>
          </div>
