...
const maxRadius = Math.min(window.innerWidth, window.innerHeight) / 2.5
const spiralArms = 4
...
color: { r: 40 + Math.random() * 20, g: 120 + Math.random() * 80, b: 255 - Math.random() * 80 },
}
})
...
className="absolute inset-0 rounded-full bg-[#6fb6ff]/8 border-[3px] border-[#6fb6ff]/70 shadow-[0_0_12px_2px_rgba(111,182,255,0.2)]"
/>
