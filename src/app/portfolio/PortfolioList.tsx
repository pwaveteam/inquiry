...
<span className="inline-block text-primary bg-primary/10 text-[13px] md:text-[15px] font-medium px-[10px] md:px-[13px] py-[2px] md:py-[3px] rounded-full mb-[8px] md:mb-[10px] leading-tight tracking-tight">
{item.theme}
</span>
